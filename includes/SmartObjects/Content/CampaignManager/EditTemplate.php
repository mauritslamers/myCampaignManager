<span class="textPageTitle">Edit Template</span><br />
  ...
  <input type="hidden" name="RequestObject" value="Objects.CampaignManager.EditTemplate">
  <input type="hidden" name="template_id" value="<? print $this->oTemplate->template_id; ?>">
